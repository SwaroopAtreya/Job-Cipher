...
function wordsToMd52(x2, len) {
  x2[len >> 5] |= 128 << len % 32;
  x2[getOutputLength2(len) - 1] = len;
  let a2 = 1732584193;
  let b2 = -271733879;
  let c2 = -1732584194;
  let d2 = 271733878;
  for (let i2 = 0; i2 < x2.length; i2 += 16) {
    ...
    const oldc = c2;
    const oldd = d2;
    a2 = md5ff2(a2, b2, c2, d2, x2[i2], 7, -680876936);
    d2 = md5ff2(d2, a2, b2, c2, x2[i2 + 1], 12, -389564586);
    c2 = md5ff2(c2, d2, a2, b2, x2[i2 + 2], 17, 606105819);
    b2 = md5ff2(b2, c2, d2, a2, x2[i2 + 3], 22, -1044525330);
    a2 = md5ff2(a2, b2, c2, d2, x2[i2 + 4], 7, -176418897);
    d2 = md5ff2(d2, a2, b2, c2, x2[i2 + 5], 12, 1200080426);
    c2 = md5ff2(c2, d2, a2, b2, x2[i2 + 6], 17, -1473231341);
    b2 = md5ff2(b2, c2, d2, a2, x2[i2 + 7], 22, -45705983);
    a2 = md5ff2(a2, b2, c2, d2, x2[i2 + 8], 7, 1770035416);
    d2 = md5ff2(d2, a2, b2, c2, x2[i2 + 9], 12, -1958414417);
    c2 = md5ff2(c2, d2, a2, b2, x2[i2 + 10], 17, -42063);
    b2 = md5ff2(b2, c2, d2, a2, x2[i2 + 11], 22, -1990404162);
    a2 = md5ff2(a2, b2, c2, d2, x2[i2 + 12], 7, 1804603682);
    d2 = md5ff2(d2, a2, b2, c2, x2[i2 + 13], 12, -40341101);
    c2 = md5ff2(c2, d2, a2, b2, x2[i2 + 14], 17, -1502002290);
    b2 = md5ff2(b2, c2, d2, a2, x2[i2 + 15], 22, 1236535329);
    a2 = md5gg2(a2, b2, c2, d2, x2[i2 + 1], 5, -165796510);
    d2 = md5gg2(d2, a2, b2, c2, x2[i2 + 6], 9, -1069501632);
    c2 = md5gg2(c2, d2, a2, b2, x2[i2 + 11], 14, 643717713);
    b2 = md5gg2(b2, c2, d2, a2, x2[i2], 20, -373897302);
    a2 = md5gg2(a2, b2, c2, d2, x2[i2 + 5], 5, -701558691);
    d2 = md5gg2(d2, a2, b2, c2, x2[i2 + 10], 9, 38016083);
    c2 = md5gg2(c2, d2, a2, b2, x2[i2 + 15], 14, -660478335);
    b2 = md5gg2(b2, c2, d2, a2, x2[i2 + 4], 20, -405537848);
    a2 = md5gg2(a2, b2, c2, d2, x2[i2 + 9], 5, 568446438);
    d2 = md5gg2(d2, a2, b2, c2, x2[i2 + 14], 9, -1019803690);
    c2 = md5gg2(c2, d2, a2, b2, x2[i2 + 3], 14, -187363961);
    b2 = md5gg2(b2, c2, d2, a2, x2[i2 + 8], 20, 1163531501);
    a2 = md5gg2(a2, b2, c2, d2, x2[i2 + 13], 5, -1444681467);
    d2 = md5gg2(d2, a2, b2, c2, x2[i2 + 2], 9, -51403784);
    c2 = md5gg2(c2, d2, a2, b2, x2[i2 + 7], 14, 1735328473);
    b2 = md5gg2(b2, c2, d2, a2, x2[i2 + 12], 20, -1926607734);
    a2 = md5hh2(a2, b2, c2, d2, x2[i2 + 5], 4, -378558);
    d2 = md5hh2(d2, a2, b2, c2, x2[i2 + 8], 11, -2022574463);
    c2 = md5hh2(c2, d2, a2, b2, x2[i2 + 11], 16, 1839030562);
    b2 = md5hh2(b2, c2, d2, a2, x2[i2 + 14], 23, -35309556);
    a2 = md5hh2(a2, b2, c2, d2, x2[i2 + 1], 4, -1530992060);
    d2 = md5hh2(d2, a2, b2, c2, x2[i2 + 4], 11, 1272893353);
    c2 = md5hh2(c2, d2, a2, b2, x2[i2 + 7], 16, -155497632);
    b2 = md5hh2(b2, c2, d2, a2, x2[i2 + 10], 23, -1094730640);
    a2 = md5hh2(a2, b2, c2, d2, x2[i2 + 13], 4, 681279174);
    d2 = md5hh2(d2, a2, b2, c2, x2[i2], 11, -358537222);
    c2 = md5hh2(c2, d2, a2, b2, x2[i2 + 3], 16, -722521979);
    b2 = md5hh2(b2, c2, d2, a2, x2[i2 + 6], 23, 76029189);
    a2 = md5hh2(a2, b2, c2, d2, x2[i2 + 9], 4, -640364487);
    d2 = md5hh2(d2, a2, b2, c2, x2[i2 + 12], 11, -421815835);
    c2 = md5hh2(c2, d2, a2, b2, x2[i2 + 15], 16, 530742520);
    b2 = md5hh2(b2, c2, d2, a2, x2[i2 + 2], 23, -995338651);
    a2 = md5ii2(a2, b2, c2, d2, x2[i2], 6, -198630844);
    d2 = md5ii2(d2, a2, b2, c2, x2[i2 + 7], 10, 1126891415);
    c2 = md5ii2(c2, d2, a2, b2, x2[i2 + 14], 15, -1416354905);
    b2 = md5ii2(b2, c2, d2, a2, x2[i2 + 5], 21, -57434055);
    a2 = md5ii2(a2, b2, c2, d2, x2[i2 + 12], 6, 1700485571);
    d2 = md5ii2(d2, a2, b2, c2, x2[i2 + 3], 10, -1894986606);
    c2 = md5ii2(c2, d2, a2, b2, x2[i2 + 10], 15, -1051523);
    b2 = md5ii2(b2, c2, d2, a2, x2[i2 + 1], 21, -2054922799);
    a2 = md5ii2(a2, b2, c2, d2, x2[i2 + 8], 6, 1873313359);
    d2 = md5ii2(d2, a2, b2, c2, x2[i2 + 15], 10, -30611744);
    c2 = md5ii2(c2, d2, a2, b2, x2[i2 + 6], 15, -1560198380);
    b2 = md5ii2(b2, c2, d2, a2, x2[i2 + 13], 21, 1309151649);
    a2 = md5ii2(a2, b2, c2, d2, x2[i2 + 4], 6, -145523070);
    d2 = md5ii2(d2, a2, b2, c2, x2[i2 + 11], 10, -1120210379);
    c2 = md5ii2(c2, d2, a2, b2, x2[i2 + 2], 15, 718787259);
    b2 = md5ii2(b2, c2, d2, a2, x2[i2 + 9], 21, -343485551);
    a2 = safeAdd2(a2, olda);
    b2 = safeAdd2(b2, oldb);
    c2 = safeAdd2(c2, oldc);
    d2 = safeAdd2(d2, oldd);
...
function md5cmn2(q2, a2, b2, x2, s2, t2) {
  return safeAdd2(bitRotateLeft2(safeAdd2(safeAdd2(a2, q2), safeAdd2(x2, t2)), s2), b2);
}
function md5ff2(a2, b2, c2, d2, x2, s2, t2) {
  return md5cmn2(b2 & c2 | ~b2 & d2, a2, b2, x2, s2, t2);
}
function md5gg2(a2, b2, c2, d2, x2, s2, t2) {
  return md5cmn2(b2 & d2 | c2 & ~d2, a2, b2, x2, s2, t2);
}
function md5hh2(a2, b2, c2, d2, x2, s2, t2) {
  return md5cmn2(b2 ^ c2 ^ d2, a2, b2, x2, s2, t2);
}
function md5ii2(a2, b2, c2, d2, x2, s2, t2) {
  return md5cmn2(c2 ^ (b2 | ~d2), a2, b2, x2, s2, t2);
}
...
function sha12(bytes) {
  ...
  for (let i2 = 0; i2 < N2; ++i2) {
    ...
    for (let t2 = 16; t2 < 80; ++t2) {
      W2[t2] = ROTL2(W2[t2 - 3] ^ W2[t2 - 8] ^ W2[t2 - 14] ^ W2[t2 - 16], 1);
    }
    let a2 = H2[0];
    let b2 = H2[1];
    let c2 = H2[2];
    ...
    for (let t2 = 0; t2 < 80; ++t2) {
      const s2 = Math.floor(t2 / 20);
      const T2 = ROTL2(a2, 5) + f2(s2, b2, c2, d2) + e2 + K2[s2] + W2[t2] >>> 0;
      e2 = d2;
      d2 = c2;
      c2 = ROTL2(b2, 30) >>> 0;
      b2 = a2;
...
var se_ExecuteTransactionInput = (input, context) => {
  return take(input, {
    ClientRequestToken: [true, (_) => _ ?? v4_default2()],
    ReturnConsumedCapacity: [],
...
var se_ExportTableToPointInTimeInput = (input, context) => {
  return take(input, {
    ClientToken: [true, (_) => _ ?? v4_default2()],
    ExportFormat: [],
...
var r = {};
var s = { [W]: "Region" };
var t = { [U]: "booleanEquals", [V]: [{ [U]: i, [V]: [{ [W]: f3 }, "supportsFIPS"] }, true] };
var u = { [U]: "booleanEquals", [V]: [{ [U]: i, [V]: [{ [W]: f3 }, "supportsDualStack"] }, true] };
...
var TransactWriteItemsCommand = class extends Command.classBuilder().ep({
  ...
  ResourceArnList: {
    ...
    get: (input) => {
      ...
      return (_a = input == null ? void 0 : input.TransactItems) == null ? void 0 : _a.map((obj) => {
        var _a2, _b, _c, _d;
        return [(_a2 = obj == null ? void 0 : obj.ConditionCheck) == null ? void 0 : _a2.TableName, (_b = obj == null ? void 0 : obj.Put) == null ? void 0 : _b.TableName, (_c = obj == null ? void 0 : obj.Delete) == null ? void 0 : _c.TableName, (_d = obj == null ? void 0 : obj.Update) == null ? void 0 : _d.TableName].filter((i2) => i2);
      }).flat();
    }
  }
}).m(function(Command2, cs, config, o2) {
...
bowser/src/bowser.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-NRZPI6DL.js.map
